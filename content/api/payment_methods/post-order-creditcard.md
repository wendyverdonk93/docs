---
weight: 310
meta_title: "API - Create Credit Card order - MultiSafepay Docs"
...
| description                     | string | A text which will be shown with the order in your MultiSafepay Control. If the customer's bank supports it this will also be shown on the bank statement. Max. 200 characters. HTML is not supported. Use the 'items' or 'shopping_cart' objects for this. |
