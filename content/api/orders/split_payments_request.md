...
{{< description >}}
## Split Payments
The split payment tool allows you to split the amount of a transaction over several M[ultiSafepay Control](/faq/general/glossary/#multisafepay-control) accounts. [Merchants](/faq/getting-started/glossary/#merchant) can choose to split payments based on percentage, a fixed amount or a combination of the two.
...
A text which will be shown with the order in [MultiSafepay Control](/faq/general/glossary/#multisafepay-control) If the customer's bank supports it this description will also be shown on the customer's bank statement. Max. 200 characters. HTML is not supported. Use the 'items' or 'shopping_cart' objects for this.
...
Affiliate AccountID of a [MultiSafepay Control](/faq/general/glossary/#multisafepay-control)   
