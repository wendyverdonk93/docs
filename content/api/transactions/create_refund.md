...
A description to be displayed with the transaction in [MultiSafepay Control](https://merchant.multisafepay.com/) If supported by the customers bank this description will be displayed on the customers bank statement.
