---
title : "3D Secure"
meta_title: "FAQ General - 3D Secure - MultiSafepay Docs"
...
3D Secure (3DS) is an authentication protocol for online transactions. It is also known by brand names such as Mastercard Identity Check, Visa Secure, or American Express SafeKey. 

Two versions of the 3D Secure protocol currently coexist: 3DS 1.0 and 3DS 2.0.

**Note:** All European transactions through the MultiSafepay platform use the 3D Secure protocol in order to comply with PSD2 regulations.

## Relationship with PSD2 and SCA
...
**Note:** We are working on supporting 3DS 2.0 and we expect to rollout the support in 2021. In the meantime, transactions use 3DS 1.0 and are fully PSD2 compliant.
