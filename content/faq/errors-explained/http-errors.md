...
| HTTP 301: Moved permanently | The page has moved permanently. Adjust where we send the [notification URL](/faq/api/how-does-the-notification-url-work) to in your MultiSafepay account and/or the transaction request. | 
| HTTP 302: Found | The page redirects to another location. Adjust where we send the [notification URL](/faq/api/how-does-the-notification-url-work) to in your MultiSafepay account and/or the transaction request. |                 
