...
MultiSafepay provides a test platform currently only for Intersolve coupons. During the payment process you will be able to simulate the outcome of the transaction.
