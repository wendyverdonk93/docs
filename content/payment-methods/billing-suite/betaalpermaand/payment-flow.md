...
|  | The transaction appears in both your MultiSafepay account and the backend of your ecommerce integration via the [Notification URL](/faq/api/notification-url/). | | |
| 4. | Ship the order. | | |
