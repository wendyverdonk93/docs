...
| **Currencies**  | EUR, SEK, NOK, DKK | [Multi-currency setup](/payment-methods/billing-suite/klarna/user-guide/activating-multi-currency-setup/) {{< br >}} [More information](/faq/general/supported-currencies) | 
