...
Once the Klarna Gateway is configured, you can start your integration using our [ecommerce integrations](/integrations/ecommerce-integrations) or by creating your own implementation with our [API](/api)
...
If you are a merchant, email our Integration Team at <integration@multisafepay.com>
...
{{< alert-notice >}} From May 11th onwards, a Klarna transaction will no longer have the status _Initialized_ after acceptance of an order. This will be replaced by the status _Uncleared_ and will be changed to _Completed_ after shipment of the order and payment settlement from Klarna. Following this, the funds will be added to your account. If you have any questions regarding this change email our Support Team at <support@multisafepay.com> {{< /alert-notice >}} 
