...
intro_description: "in3 is a Dutch online buy now pay later service where customers pay in 3 installments at no extra cost and without having to register with the Bureau Krediet Registratie (BKR). in3 processes all the installments and guarantees payout after receiving the first one."
faq: '.'
logo: '/svgs/in3.svg' 
short_description: 'Dutch buy now pay later service where customers pay in 3 installments'
aliases:
