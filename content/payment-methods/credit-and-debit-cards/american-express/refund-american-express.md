...
---
## Request refund
The refund of a transaction with the payment method American Express can be processed from within your [MultiSafepay Control](https://merchant.multisafepay.com)
