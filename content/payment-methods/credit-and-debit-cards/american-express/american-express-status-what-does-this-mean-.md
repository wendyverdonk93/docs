...
---
## Declined
If an American Express payment of a customer receives the status _declined_, it may be for several reasons. Only the customer can contact their credit card [issuer](/faq/general/glossary/#issuer) to inquire as to why the credit card payment has been _declined_.
