...
When a chargeback is filed against the merchant with the __chargeback reason: Fraud__ and the transaction was carried out through the 3D Secure system, the acquiring bank is responsible for the costs and not the merchant.