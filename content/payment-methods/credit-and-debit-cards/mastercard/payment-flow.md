...
| 3. | The customer enters their credit card details, verifies their identify via [SecureCode](/faq/payment-regulations/about-3d-secure/), and completes the payment. | | |
...
| 7. | Mastercard settles the funds with MultiSafepay. | Completed | Completed |
...
For refund statuses, see [Processing refunds](/payment-methods/credit-and-debit-cards/mastercard/user-guide/processing-refunds/).
