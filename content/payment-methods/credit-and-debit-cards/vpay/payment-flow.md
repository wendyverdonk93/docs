...
| 7. | V Pay settles the funds with MultiSafepay. | Completed | Completed |
...
For refund statuses, see [Processing refunds](/payment-methods/credit-and-debit-cards/vpay/user-guide/processing-refunds/).
