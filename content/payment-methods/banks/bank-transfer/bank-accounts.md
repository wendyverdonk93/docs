...
If you prefer to send payment instructions to the customer yourself, set the *disable_send_email* parameter to _false_ in the corresponding [API](/faq/general/glossary/#api) call. In this case, MultiSafepay does not send the customer an email notification.
