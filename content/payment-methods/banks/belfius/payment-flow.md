...
The table below shows a successful Belfius payment flow from start to finish.  
...
| 3. | The transaction is successful, and Belfius settles the funds with MultiSafepay.  | Completed | Completed |
...
For how to process refunds, see [Processing refunds](/payment-methods/banks/belfius/user-guide/processing-refunds/).
