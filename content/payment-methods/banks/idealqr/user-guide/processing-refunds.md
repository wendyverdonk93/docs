...
meta_title: "iDEAL QR - Processing refunds - MultiSafepay Docs"
...
## Via our API
Make a POST `/orders/{order_id}/refunds` request. See API Reference – [Create a refund](/api/#ref_create_refund).
