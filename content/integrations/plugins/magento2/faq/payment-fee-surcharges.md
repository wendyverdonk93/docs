...
_It may be the case that unwanted Custom Order Totals will appear on the MultiSafepay payment page.  If you wish for this amount to be excluded, there is an option in the backend of our extension in Magento 2, which can exclude such totals. This option will however not be required if you use extensions or modules that follow the Magento guidelines._