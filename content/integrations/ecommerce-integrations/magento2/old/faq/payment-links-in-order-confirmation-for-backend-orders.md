...
1. Log in to your Magento backend. Check how we do it [here](/integrations/ecommerce-integrations/magento2/old) in step 3. 
...
`{{/depend}}`\
   ...
   Please note that with this sample code, the payment link will also be available in frontend order confirmation e-mails.
