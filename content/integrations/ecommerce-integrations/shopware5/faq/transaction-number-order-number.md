...
The transaction number is generated when the transaction is initialized. MultiSafepay uses this number as the `order ID` in transactions. You must therefore use this number to link payments to transactions in your MultiSafepay Control.