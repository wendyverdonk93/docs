...
It assumes you have created a test account. 

See, Getting Started - [Create a test account](/getting-started/create-a-test-account). 

### See also:

- [Testing payments](/getting-started/test-your-integration)
- [Testing refunds](/getting-started/test-your-integration/testing-refunds/)
