...
Split Payments is a feature in our [API](/api/#split-payments). This is not incorporated within our plugins by default, but it can be added by customization from your side.  
