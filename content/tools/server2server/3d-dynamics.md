...
* If multiple site are connected within a [MultiSafepay Control](/faq/general/glossary/#multisafepay-control) account, we need to know for which sites the Dynamic 3D Secure should be implemented.
