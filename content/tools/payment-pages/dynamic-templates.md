...
---
For merchants with a custom integration via [JSON API MultiSafepay](/api/), MultiSafepay also offers dynamic styling of the templates. This means you can change the look & feel of a Payment page per transaction.
...
MultiSafepay also offers real-time styling of the templates. This means you can change the look & feel of a Payment page per transaction on the fly. You need to add the following to your transaction request:
```
    "template": {
        "version": "1.0",
        "settings": {
