...
Available for [JSON](/faq/general/glossary/#json) API only. You can find more details on our [API documentation on tokenization](/api/#tokenization-recurring-model)
