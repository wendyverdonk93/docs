...
## Set a template
An email template can be set within your MultiSafepay account under: _**Settings > Email template > Select a website > Add new template.**_ 
...
This email is intended as a friendly reminder to your customer in the event of a payment that has not been completed yet. 
    ...
    When the standard or personalized Second Chance email template is set up, it is important to enable the Second Chance in your MultiSafepay account under **_Settings > Website settings > select a website > enable the Second Chance email per website._**
